...
CREATE TABLE `person_visit` (
  ...
  KEY `fk_visit_num_idx` (`visit_num`),
  CONSTRAINT `fk_person_id` FOREIGN KEY (`person_id`) REFERENCES `person_master` (`person_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_visit_num` FOREIGN KEY (`visit_num`) REFERENCES `visit_master` (`visit_num`)
...
-- Dump completed on 2024-04-29 10:15:53
